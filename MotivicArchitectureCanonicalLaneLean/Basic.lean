/-!
# motivic-architecture-canonical-lane Lean migration boundary
...
`MotivicArchitectureCanonicalLaneLean/SourcePackage.lean`.
...
def sourceRepository : String := "motivic-architecture-canonical-lane"
def sourceUrl : String := "https://github.com/HautevilleHouse/motivic-architecture-canonical-lane"
def sourceDescription : String := "Canonical-lane closure package for Motivic Architecture: admissible-class formulation, projection gates, local-to-global bridge, and carried remainder."
def sourceClassification : String := "abstract_math_theorem_repo"
def sourceTopics : List String := ["arithmetic-geometry", "mathematical-proof", "motives", "motivic-cohomology", "reproducibility", "manifold-constrained", "canonical-lane", "local-to-global"]
