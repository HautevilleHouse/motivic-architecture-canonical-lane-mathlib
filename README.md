# Motivic Architecture — Canonical Lane Mathlib
...
```bash
git clone https://github.com/HautevilleHouse/motivic-architecture-canonical-lane-mathlib.git
cd motivic-architecture-canonical-lane-mathlib
lake exe
lake build
```
